...
def work_exp(inputlist,weparameters,mypathh):
   
    expScr=weparameters["expScr"]
    companyTierScr=weparameters["companyTierScr"]
    recentExpScr=weparameters["recentExpScr"]
    otherRolescr=weparameters["otherRolescr"]
    resd={}
    res_incomplete={}
    ...
    for i in comp_str:
                    ...
                    if title !="":
                            ...
                            if z['JobPosition']!="":
                                ...
                                if z['JobPosition'] in resume_list:
                                    ...
                                    if z["CompanyTier"]=='':
                                        jdtier=3
                                        #print(company_tier)
                                        score=companyTierScr+math.tanh((company_tier-jdtier)/1.5)
                                    if z["CompanyTier"]!='':
                        ...
                        if count!=0:
                            ...
                            if incomplete_count!=0:
                                incomplete_score=incomplete_score/incomplete_count
                            #print(score)
                        if nlcount!=0:
        ...
        res_incomplete[i]=incomplete_score/len(inputlist)
    #print(resd)                            
    resd=dict( sorted(resd.items(), key=operator.itemgetter(1),reverse=True))
    res_incomplete=dict( sorted(res_incomplete.items(), key=operator.itemgetter(1),reverse=True))
    return resd,res_incomplete
...
#     "companyTierScr":10,
#     "recentExpScr":10,
#     "otherRolescr":10},"C:/Users/User/Desktop/Darwinbox/stack ranking/SovrenProductDemo-12_Resumes/")
